...
button4 = Button(frame, text=4, height=4 , width=9 , font=35,  relief=RAISED,command=lambda: button_press(4))
...
clearr = Button(frame, text="clear", height=4 , width=9 , font=35, command=clear)
clearr.grid(row=4, column=0)

power = Button(frame , text= "**", height=4, width=9, font= 35, command= lambda: button_press("**") )
power.grid(row=4, column=1)

modulus = Button(frame, text= "%", height=4, width=9,font=35, command=lambda : button_press("%"))
modulus.grid(row=4, column=2)
